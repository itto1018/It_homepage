          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div id="profile-image" className="p-6 bg-gray-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div className="relative h-32 w-32 overflow-hidden rounded-full ring-4 ring-white shadow-md">
                  {imageUrl ? <Image src={imageUrl} alt="プロフィール画像" fill className="object-cover" /> : <div className="h-full w-full bg-blue-50" />}
                </div>
                <div>
            ...
            <div className="space-y-6">
              <div id="profile-nickname">
                <label htmlFor="profile-nickname" className="block text-sm font-medium text-gray-700 mb-2">
                  ニックネーム
                </label>
                <input
                  type="text"
